...
public class EnumHelper {
	...
	public static <T extends Enum<?>> T addEnum(Class<T> enumType, String enumName, Class<?>[] paramTypes, Object[] paramValues) {
		if (Float.parseFloat(System.getProperty("java.class.version")) != 52.0) {
			return Java9.addEnum(enumType, enumName, paramTypes, paramValues);
		} else {
			return Java8.addEnum(enumType, enumName, paramTypes, paramValues);
		}
	}
	...
	private static class Java9 {
		private static MethodHandles.Lookup impl_lookup = null;
		private static boolean isSetup = false;
		...
		private static void setup() {
			...
			try {
				...
				Field impl_lookupField = MethodHandles.Lookup.class.getDeclaredField("IMPL_LOOKUP");
				impl_lookup = (MethodHandles.Lookup) unsafe.getObject(unsafe.staticFieldBase(impl_lookupField), unsafe.staticFieldOffset(impl_lookupField));
			} catch (Exception e) {
				e.printStackTrace();
			}
