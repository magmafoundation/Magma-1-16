...
public class CraftWorld implements World {
    ...
    public boolean isChunkGenerated(int x, int z) {
        try {
            return isChunkLoaded(x, z) || world.getChunkSource().chunkMap.readChunk(new ChunkPos(x, z)) != null;
    ...
    public void setClearWeatherDuration(int duration) {
        world.serverLevelData.setClearWeatherTime(duration); // PAIL rename setClearWeatherDuration
    }

    @Override
    public int getClearWeatherDuration() {
        return world.serverLevelData.getClearWeatherTime(); // PAIL rename getClearWeatherDuration
    }
    ...
    public void setKeepSpawnInMemory(boolean keepLoaded) {
        ...
        if (keepLoaded) {
            ...
            world.getChunkSource().releaseTickingTicket(TicketType.START, new ChunkPos(chunkcoordinates), 11, Unit.INSTANCE);
        }
    }
    ...
    public File getWorldFolder() {
        return world.convertable.getLevelPath(FolderName.ROOT).toFile().getParentFile();
    }
    ...
    private final Spigot spigot = new Spigot()
    {
        ...
        {
            LightningBoltEntity lightning = net.minecraft.entity.EntityType.LIGHTNING_BOLT.create( world );
            lightning.absMoveTo( loc.getX(), loc.getY(), loc.getZ() );
